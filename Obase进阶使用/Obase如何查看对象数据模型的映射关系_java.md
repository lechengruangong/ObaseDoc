...
```
//获取完整的信息
StringBuilder full = ObjectDataModelViewer.getFullObjectDataModelMappingView(context);
//获取简单的信息
StringBuilder simple = ObjectDataModelViewer.getSimpleObjectDataModelMappingView(context);
```
