...
2. [Obase如何配置一个类和自己的关联(dotNet版)](./Obase如何配置一个类和自己的关联_dotNet.md)和[Obase如何配置一个类和自己的关联(java版)](./Obase如何配置一个类和自己的关联_java.md).主要介绍了一个类和自己有关联时进行配置的实例.比如省-市-区这种行政区划的关系.
